...
/*
-2242,   -3232,     330,     160,     -51,      42             _________________________________________________________*/
...
void loop() {
  ...
  Serial.print(mpu.quat[0]);
  Serial.print(mpu.quat[1]);
  Serial.print(mpu.quat[2]);
  Serial.println(mpu.quat[3]);
}